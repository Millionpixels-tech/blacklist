          ...
          <div className="job-search">
            <CardBody>
              <div className="media">
                <div className="media-body">
                  <H2 attrH6={{ className: "f-w-600" }}>
                    ...
                    >
                      Punchi Hewalage Malkanthi Punchihewa
                    </Link>
                    {/* <span className='pull-right'>2 days ago</span> */}
                    {/* Edit Icon */}
                    <span> <Link
                      to={`${process.env.PUBLIC_URL}/users/edit`}
                      className="edit-icon"
                    >
              ...
              <P>
                ...
                frontend engineer with expertise in accessibility to join our
                team, 3+ years of experience working in as a Frontend Engineer
                or comparable role.You won’t be a team of one though — you’ll be
