...
import { CompanyTableTitle, Delete, Edit, Update, UsersTableHeader, UsersTableTitle } from '../../Constant';
            ...
            <tbody>
              {data.map((items, i) => (
                <tr key={i}>
                  ...
                  <td>{items.desc.length > 50 ? `${items.desc.substring(0, 50)}...` : items.desc}</td>
