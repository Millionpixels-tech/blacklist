        ...
        <Fragment key={i}>
          ...
          {Item.Items.map((menuItem, i) => (
            <li className="sidebar-list" key={i}>
              ...
              {menuItem.children ? (
                <ul className="sidebar-submenu" style={(menuItem?.active || CurrentPath.includes(menuItem?.title?.toLowerCase()) ? (sidebartoogle ? { opacity: 1, transition: "opacity 500ms ease-in" } : { display: "block" }) : { display: "none" })}>
